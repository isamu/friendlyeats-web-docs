...
Reactサーバがローカルで起動しています。 ブラウザ http://localhost:5000 を開くとサンプルアプリを見ることができます。 Reactを起動すると自動的に開く場合もあります。5000という数字は少し別の番号になっている場合もあります。
...
1. scripts/FriendlyEats.Data.js を開く
1. FriendlyEats.prototype.addRating 関数を探す
1. 関数全体を以下のコードに置き換えます
